...
public class Scalr {
	 ...
	 * @see Mode
	 */
	public static BufferedImage resize(BufferedImage img, Method scalingMethod,
			Mode resizeMode, int targetWidth, int targetHeight,
			ColorConvertOp opGrayscale) throws IllegalArgumentException,
			ImagingOpException {
      ...
      t = System.currentTimeMillis();
		...
		if (scalingMethod == Scalr.Method.SPEED) {
			...
			if (targetWidth > currentWidth || targetHeight > currentHeight) {
				 ...
				 */
				result = scaleImageIncrementally(img, targetWidth,
		...
		// Apply any optional operations (if specified).
		//if (opGrayscale != null && opGrayscale.length > 0)
		if (opGrayscale != null)	
			result = apply(result, opGrayscale);
